...
using LeaveManagementCourse.Repository;
using LeaveManagementCourse.Contracts;
using LeaveManagementCourse.Mappings;
...
namespace LeaveManagementCourse
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env,
            UserManager<IdentityUser> userManager, RoleManager<IdentityRole> roleManager) // added to the configure method
        {
